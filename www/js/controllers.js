...
//        $scope.$on(AUTH_EVENTS.notAuthorized, function notAuthorized(event) {
//
...
//      });
//
//      $scope.$on(AUTH_EVENTS.notAuthenticated, function notAuthenticated(event) {
//
//        // Hide loading template
//        $ionicLoading.hide();
//
...
.controller('UploadCtrl', function($scope, $state, AUTH_EVENTS, $ionicLoading, AuthService, $ionicHistory) {
